<div class="my-16">
    <div
        ...
        <div class="mb-5">
            ...
            <p class="text-gray-500">Fill out the form below with your case details, and our
        ...
        <form wire:submit="submit">
            @if ($message)  
                <div class="mb-4">
                    <p class="text-{{$status ?? 'success'}}">{{$message}}</p>
                </div>            
            @endif
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="company" placeholder="Company Name"/>
