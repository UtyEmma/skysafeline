<x-guest-layout>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-full px-4">
                    <div class="wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <p class="mx-auto mb-9 text-base font-medium text-white sm:text-lg sm:leading-[1.44]">Have you fallen victim to online scams or cyber fraud? Skysafeline understands the frustration and loss that comes with these unfortunate incidents. But here's the good news – you're not alone, and recovery is possible.</p>
                    </div>
                </div>
    ...
    <section id="about" class="pb-8 pt-20 lg:pb-[70px] lg:pt-[120px]">
        <div class="container">
            <div class="wow fadeInUp" data-wow-delay=".2s">
                <div class="-mx-4 flex flex-wrap items-center">
                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        <img src="{{asset('cyber-recovery.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="-mx-4 flex flex-wrap items-stretch">
                    <div class="w-full px-4">
                        <div class="mx-auto max-w-5xl text-center">
                            <h2 class="mb-10 text-3xl font-bold text-white md:text-[38px] md:leading-[1.44]">
                            ...
                            <a href="#report" class="inline-block rounded-md border border-transparent bg-danger px-7 py-3 text-lg font-medium text-white transition hover:scale-110 my-5 ">
                                Report Now
                            </a>
                        </div>
                    </div>
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[485px] text-center">
                        ...
                        <h2 class="mb-3 text-3xl font-bold leading-[1.2] text- :text-white sm:text-4xl md:text-[40px]">
                            What Our Clients Say About Us
                        </h2>
                        <p class="text-base text-body-color :text--6">We’ve helped over 5,000 clients to recover their lost money online and we can still help you too!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="-m-5">
                <div class="swiper testimonial-carousel common-carousel p-5">
                    <div class="swiper-wrapper">
                        @forelse (config('content.testimonials') as $testimonial)
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap">
                <div class="grid md:grid-cols-2 gap-10">
                    @foreach (config('content.faqs') as $faq)
                        <div class="flex">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color :text--6">{{$faq['answer']}}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
